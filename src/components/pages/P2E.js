...
const P2E = () => {
  ...
  return (
    <div className="p2e">
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav m-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link" href="jack-pot/jackpot.html">
                  Tournaments
                </a>
              </li>
              <li className="nav-item">
            ...
            <a className="d-flex nav-link connect" href="#">
              CONNECT NOW
            </a>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 top-down">
              ...
              <a href="#">
                <img className="img-fluid" src="images/btn.png" alt="" />
              </a>
            </div>
      ...
      <div className="scetion-statistics">
        <div className="container">
          <div className="row py-5">
            ...
            <img src="images/Statistics.png" className="img-fluid" alt="" />
          </div>
          <div className="box px-4 py-2">
            <div className="row p-3">
              <div className="col-lg-3">
                <div className="mini-box d-flex">
                  <div className="mini-box d-flex">
                    <img
                      src="images/25.png"
                      className="img-fluid mx-2 my-3 box-img"
                      alt=""
                    />
                  ...
                  <img
                    src="images/Rectangle 5229.png"
                    className="img-fluid border-one"
                    alt=""
                  />
                </div>
              </div>
              <div className="col-lg-3">
                <div className="mini-box d-flex">
                  <div className="mini-2 d-flex">
                    <img
                      src="images/26.png"
                      className="img-fluid my-3 mx-2 box-img"
                      alt=""
                    />
                    <div className="l-box py-3">
          ...
          <div className="button-group">
            <a href="#">
              <img src="images/btn1.png" className="img-fluid" alt="" />
            </a>
            <a href="#">
              <img src="images/btn1 (1).png" className="img-fluid" alt="" />
            </a>
            <a href="#">
              <img src="images/btn1 (2).png" className="img-fluid" alt="" />
            </a>
          </div>
        </div>
      </div>
      <div className="section-benifits">
        <div className="container">
          ...
          <p className="text-white last-text p-4">
            We believe that helping people on this planet that live below the
            breadline is important and we all need to play our part. Crypto Phil
            has started a campaign to donate 1 day per month income to those in
            need. We salute Phil for this and will be donating 0.3% of the TVL
            to this cause. Follow Crypto Phil on YouTube to see these funds in
            action and see how you can do your part. Here's a video on where the
            charity funds will go. <a href="#">Click Here!</a>
          </p>
        </div>
      </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-two">
              ...
              <div className="wallter-box p-1 my-4 leftm-60">
                <div className="one d-flex px-5 py-3">
                  <img src="images/33.png" className="img-fluid my-2" alt="" />
                  <div className="text-one mx-3">
              ...
              <div className="wallter-box p-1">
                <div className="one d-flex px-5 py-3">
                  <img src="images/26.png" className="img-fluid my-2" alt="" />
                  <div className="text-one mx-3">
          ...
          <div className="row">
              ...
              <div className="main-box d-block">
                <div className="box-hire p-2">
                  ...
                  <div className="box-hire-one d-flex">
                    <img src="images/30.png" className="mx-2" alt="" />
                  ...
                  <div className="box-hire-one two py-2 me-3 d-flex">
                    <img src="images/9.png" className="mx-2" alt="" />
                    <div className="box-hire-one-text mx-2">
                      <p>Wallet</p>
                  ...
                  <div className="deposit">
                    <p className="text-white px-3">
                      1. Deposit BNB <span>( min 0 , max 0 )</span>
                    </p>
                    <input type="number" className="px-2 mx-3 text-white" />
                    <button className="text-center mx-3 my-4 text-white">
                      HIRE 0 FARMERS
                    </button>
                  </div>
                </div>
            ...
            <div className="col-lg-6  py-4">
              <div className="another-box text-center p-5">
                ...
                <input
                  type="text"
                  placeholder="Sell crops in 00:00:00 -80% tax"
                  className="text-white px-3 mt-5"
                />
                <button className="text-center mx-3 my-4">
                  HIRE MORE FARMERS (+0%)
                </button>
              </div>
            </div>
      ...
      <div className="faq">
        <div className="container">
          <img src="images/FAQ.png" className="img-fluid my-5" alt="" />
          <div className="row">
      ...
      <div className="footer">
        <div className="container">
          <div className="row">
            <div className="col-lg-3">
              <a href="#">
                <i className=" text-white one fa-brands fa-facebook-f" />{" "}
              </a>
              <a href="#">
                <i className=" text-white mx-3 two fa-brands fa-twitter" />
              </a>
              <a href="#">
                <i className="text-white two fa-brands fa-instagram" />
              </a>
            </div>
            <div className="col-lg-6">
              <p className="text-white">
                Copyright © 2021 Space Miners.All Rights Reserved.
              </p>
            </div>
            <div className="col-lg-3">
              <p className="text-white">
                Privacy Policy <span className="mx-3">|</span> Term of Use
              </p>
            </div>
          </div>
        </div>
